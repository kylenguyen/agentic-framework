...
# Usage: ufw.sh [--dry-run] <lan-cidr>        e.g. sudo bash config/ufw.sh 192.168.10.0/24
...
LAN=${1:-}
[ $# -eq 1 ] && params_is_cidr "$LAN" || { echo "usage: $0 [--dry-run] <lan-cidr>   (e.g. 192.168.10.0/24)" >&2; exit 2; }
